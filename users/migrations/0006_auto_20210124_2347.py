# Generated by Django 2.2.5 on 2021-01-24 14:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='language',
            field=models.CharField(blank=True, choices=[('en', 'English'), ('kr', 'Korean')], max_length=5, null=True, verbose_name='언어유형'),
        ),
        migrations.AlterField(
            model_name='user',
            name='superhost',
